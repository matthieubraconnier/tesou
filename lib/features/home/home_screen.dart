...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _showComingSoon(String action) {
    ScaffoldMessenger.of(context)
      ..hideCurrentSnackBar()
      ..showSnackBar(
        SnackBar(content: Text('$action — fonction bientôt disponible')),
      );
  }
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${relatives.length} groupes visibles · aucun partage permanent',
      ...
      child: InkWell(
        ...
        onTap: () {
          ScaffoldMessenger.of(context)
            ..hideCurrentSnackBar()
            ..showSnackBar(
              SnackBar(content: Text('${relative.name} — détails bientôt disponibles')),
            );
        },
        child: Padding(
...
class _BalloonMascot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      ...
      image: true,
      child: SizedBox(
        width: compact ? 68 : 128,
        height: compact ? 92 : 174,
